...
const NewAdsHero = () => {
  return (
    <div className='flex flex-col'>
        {/* 1st sec */}
        <div className='relative h-[440px] flex justify-end items-center'>
            ...
            <div className='flex flex-col w-1/2 justify-center gap-5'>
                <p className='text-white font-bold text-4xl'>Skitch Ads</p>
                <p className='text-white font-bold text-4xl max-w-xs'>India's largest Restaurant <span className='text-[#FFC444]'>Digital Screen Network</span></p>

                <p  className='text-white font-medium text-sm max-w-[220px]'>Unleash your brand's potential with India’s largest network of connected Digital Screens</p>
        ...
        <div className='w-full h-[400px] flex justify-center '>
            ...
            <p className='text-[#FFC444] font-bold text-2xl max-w-xs'>Ready to elevate your marketing mix?</p>
            <p className='max-w-[230px] text-sm'>Gain access to a never seen
        ...
        <div className='relative h-[600px] flex flex-col justify-center items-center gap-12'>
            <img className='absolute -z-10 top-0 left-0 w-full' src={emptterrace} alt="" />
            <p className='text-white'>Why RESTAURANT?</p>
            ...
            <div className='flex gap-28'>
                <section className='flex flex-col items-center gap-3'> <p className='text-center text-white font-semibold text-lg max-w-[150px]'>Rise in annual consumption</p>
                    <p className='text-white max-w-xs text-[10px] font-thin'>The restaurant industry is growing rapidly,
                ...
                <section className='flex flex-col items-center gap-3'> <p className='text-center text-white font-semibold text-lg max-w-[150px]'>Decrease in brand loyalty</p>
                    <p className='text-white max-w-xs text-[10px] font-thin'>
                ...
                <section className='flex flex-col items-center gap-3'> <p className='text-center text-white font-semibold text-lg max-w-[150px]'>Growth of Audience</p>
                    <p className='text-white max-w-xs text-[10px] font-thin'>he shift to online sales is a major trend that is transforming the retail industry. Consumers are increasingly looking for convenience and value when they shop, and online shopping offers both of these benefits. As a result, the share of online sales is expected to continue to grow in the coming years.
In short, people are buying more and more things online, and this trend is expected to continue.
        ...
        <div className='flex flex-col gap-4 justify-center items-center h-[650px] bg-[#FDF3DB]'>
            <p className='text-4xl text-center text-[#FFC444]'>
            Let's begin your journey together! <br />
            <span className='font-bold'> What are you waiting for?</span>
            </p>

            <p className='text-[#FFC444] max-w-lg text-[10px] '>
...
Advertising (DOOH) medium.
            ...
            {/* 5th sec */}
            <div className='flex flex-col justify-center items-center h-[500px] bg-[#eaebef]'>
            ...
            <div className='flex flex-col justify-center items-center h-[300px] gap-6'>
                ...
                <div className='flex gap-8'>
                    {
                        stakearr.map((item)=>(
                            <img className='w-20' src={item} alt="" />
                        ))
                    }
                </div>
            </div>
            ...
            {/* 7th sec  */}
            <div className='flex justify-between bg-[#FCF8ED] h-[300px]'>
                <img className='w-[800px]' src={served} alt="" />
                <div className='flex flex-col justify-center items-center  gap-8 pr-40'>
                    <p>Skitch Ads CAMPAIGN STORIES</p>
            ...
            {/* 8th sec  */}
            <div className='flex justify-center gap-10 bg-[#D5D8E0B5] h-[300px]'>
               
                <div className='flex flex-col justify-center items-start  gap-4 '>
                    <p>GET IN TOUCH TODAY</p>
                    <p className='text-[#FFC444] text-2xl max-w-sm '>Learn more about our platform from an Skitch Ads Expert</p>
                    <p className=' max-w-sm '>We’re on a mission to amplify brand stories
through digital screens – if that sounds like
you, get in touch today.</p>
                    <button className='bg-[#FFC444] w-[200px] h-[30px] rounded-2xl font-bold text-md text-white '>Contact Us</button>
                </div>
                <img className='w-[300px] pt-4' src={hash} alt="" />
            </div>
    </div>
  )
}
