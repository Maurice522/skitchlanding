...
const AICards = () => {
  ...
  return (
    <>
    <div className='flex w-4/5 mx-auto justify-center items-center py-10'>
        <div className='flex flex-col  items-center shadow-lg h-[42rem] border-r rounded-l-[26px]'>
            <p className=' px-8 text-[40px] max-w-[24rem] text-center font-bold bg-[#FFCC5F] rounded-ss-[26px]'>AI-Powered  Chat Bot</p>
            ...
            <p className=' px-10 pb-12 max-w-[24rem] font-medium text-[#717171] text-xs text-center'>An AI-powered custom chatbot is like having a personalized virtual assistant.
                 ...
                 <button onClick={()=>signhandleOpen()} className=' w-48 h-10  shadow'>Know More</button>
        </div>
        <div className='flex flex-col  items-center shadow-lg h-[42rem] border-l rounded-r-[26px]'> 
            <p className='px-8 text-[40px] max-w-[24rem] text-center font-bold bg-[#57C5B6] rounded-se-[26px]'>AI-Powered ERMS (POS)</p>
    ...
    <div className='w-full flex justify-center p-16'>
        <button onClick={()=>navigate("/skitchads")} className=' butshadow flex justify-center items-center p-3 gap-14 border-4 border-black shadow-md '>
        Are you a brand, owner, click here <img className='w-12' src={arrow} alt="" />
        </button>
        </div>
